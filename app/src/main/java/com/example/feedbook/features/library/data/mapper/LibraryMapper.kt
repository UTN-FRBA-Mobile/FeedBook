...
private fun CurrentBookDto.toDomain(): LibraryCurrentBook =
    LibraryCurrentBook(title, author, page, totalPages, progress, coverAccentHex)

private fun LibraryBookDto.toDomain(): LibraryShelfBook = LibraryShelfBook(title, accentHex)
