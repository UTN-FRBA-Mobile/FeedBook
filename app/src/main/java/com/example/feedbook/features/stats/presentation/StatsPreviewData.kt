...
fun previewStatsUiState(): StatsUiState = emptyStatsUiState().copy(
    ...
    radarSections = listOf(
        RadarSection(
            ...
            ranking = listOf(
                ...
                RankingItem(3, "Fantasy"),
                RankingItem(4, "Mystery"),
                RankingItem(5, "Romance")
            )
        ),
        RadarSection(
            mode = "Author",
            ...
            ranking = listOf(
                ...
                RankingItem(3, "Ursula K. Le Guin"),
                RankingItem(4, "Margaret Atwood"),
                RankingItem(5, "Arthur Conan Doyle")
            )
        )
    )
)
